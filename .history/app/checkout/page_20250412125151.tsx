      ...
      import("pdfmake/build/pdfmake").then((pdfMakeModule) => {
        ...
        if (pdfMake) {
          ...
          const docDefinition: TDocumentDefinitions = {
            ...
            // On ne définit pas de styles complexes ici
            styles: {
              header: {
                fontSize: 20, // Taille du texte pour l'en-tête
                marginBottom: 10,
                alignment: 'center',
              },
              footer: {
            ...
            defaultStyle: {
              font: 'Helvetica', // Utilisation de la police par défaut sans spécifications supplémentaires
            },
          };
