...
export async function generateInvoice(items: any[], total: number) {
  ...
  if (typeof window !== "undefined") {
    ...
    const pdfMake: any = pdfMakeModule.default; // Utiliser 'any' pour éviter les problèmes de type
    const pdfFonts: any = pdfFontsModule.default; // Utiliser 'any' pour éviter les problèmes de type
